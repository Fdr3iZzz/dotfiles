# desktop specific home-manager configuration
{
  ...
  ...
	...
	services = {
		# clipvault might be better (image preview)
		# remember to avoid storing passwords (e.g. KeePassXC)
	...
	wayland.windowManager.hyprland = {
		...
		settings = {
			...
			windowrule = [
				''match:class ^ueberzugpp\w*, no_anim on''
				"match:class ^ueberzugpp\w*, float yes"
			];
		};
